...
export type EventTag = 'start' | 'place' | 'crane' | 'crane-drop' | 'wave' | 'down' | 'rescue' | 'win' | 'lose';
export type GameEvent = { id: string; text: string; kind: 'info' | 'danger' | 'good'; at: number; tag?: EventTag; actor?: string; x?: number; z?: number };
