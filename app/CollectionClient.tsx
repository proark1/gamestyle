...
const CARD_CONFIGS: Record<string, CardStaticConfig> = {
  ...
  'bungee-doubles': {
    ...
    imgSrc: '/images/bungee-doubles.png?v=red-blue',
    imgAlt:
      'Two toy padel players in red shirts tethered by an elastic bungee cord dive across the green court for a smash off the back glass.',
    loading: 'lazy',
    tagIcon: Gamepad2,
    metaIcon1: Users,
    metaIcon2: Timer,
  ...
  'panic-curling': {
    ...
    imgSrc: '/images/panic-curling.png?v=red-blue',
    imgAlt:
      'Toy curling players in red and blue sweep ice furiously while a teammate in a laundry basket slides toward the target ring.',
    loading: 'lazy',
    tagIcon: Snowflake,
    metaIcon1: Users,
    metaIcon2: Timer,
  ...
  basketball: {
    ...
    imgSrc: '/images/court-clash.png?v=red-blue',
    imgAlt:
      'Four toy basketball players in red and blue jerseys compete on an outdoor court as one leaps toward the hoop for a slam dunk.',
    loading: 'lazy',
    tagIcon: Gamepad2,
    metaIcon1: Users,
    metaIcon2: Timer,
  ...
  'crane-clash': {
    ...
    imgSrc: '/images/crane-clash.png?v=red-blue',
    imgAlt:
      'Workers swing from red and blue crane cables carrying wooden crates toward two teetering towers while their teammates operate the cranes.',
    loading: 'lazy',
    tagIcon: HardHat,
    metaIcon1: Users,
    metaIcon2: Timer,
