...
Release validation: isolated checkout based on origin/main 2d8855d passes full TypeScript checking, the Railway production build, scoped lint, changed-file formatting, and all 183 Reel Problems tests. The shared-workspace type errors are absent from the release.
