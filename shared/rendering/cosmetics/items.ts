...
export const ITEM_MODELS: Record<string, ItemModel> = {
  ...
  'master-disguise': {
    slot: 'face',
    parts: [
      orb('face', [0.14, 0.12, 0.16], [0, -0.06, 0.28], '#d64d55'),
      cube('face', [0.46, 0.08, 0.04], [0, 0.04, 0.23], '#1a1a1a'),
      cube('face', [0.48, 0.08, 0.06], [0, 0.14, 0.24], '#1a1a1a', {
        rounded: true,
      }),
      cube('face', [0.36, 0.1, 0.08], [0, -0.16, 0.26], '#1a1a1a', {
        rounded: true,
      }),
    ],
  },
  'pirate-eyepatch': {
    slot: 'face',
    parts: [
      cube('face', [0.16, 0.16, 0.03], [0.13, 0.03, 0.25], '#1b1c1e', {
        rounded: true,
      }),
      cube('face', [0.52, 0.035, 0.03], [0, 0.05, 0.24], '#242528', {
        turn: [0, 0, -0.35],
      }),
      orb('face', [0.035, 0.035, 0.02], [0.13, 0.03, 0.27], '#f4f0e6'),
    ],
  },
  'monocle-goatee': {
    slot: 'face',
    parts: [
      cone('face', [0.09, 0.09, 0.02], [0.13, 0.03, 0.25], '#ffd700', {
        sides: 16,
        turn: [QUARTER, 0, 0],
      }),
      cone('face', [0.075, 0.075, 0.02], [0.13, 0.03, 0.255], '#edf6f9', {
        sides: 16,
        turn: [QUARTER, 0, 0],
      }),
      cube('face', [0.025, 0.2, 0.02], [0.22, -0.06, 0.23], '#ffd700', {
        turn: [0, 0, -0.2],
      }),
      cone('face', [0.07, 0.01, 0.14], [0, -0.26, 0.23], '#2b2b2b', {
        sides: 8,
        turn: [-QUARTER, 0, 0],
      }),
    ],
  ...
  'pixel-shades': {
    slot: 'face',
    parts: [
      cube('face', [0.5, 0.1, 0.03], [0, 0.03, 0.25], '#111111'),
      cube('face', [0.18, 0.06, 0.03], [-0.14, -0.04, 0.25], '#111111'),
      cube('face', [0.18, 0.06, 0.03], [0.14, -0.04, 0.25], '#111111'),
      cube('face', [0.04, 0.04, 0.035], [-0.18, 0.04, 0.26], '#ffffff'),
    ],
  },
  'welding-goggles': {
    slot: 'face',
    parts: [
      cube('face', [0.55, 0.06, 0.04], [0, 0.03, 0.24], '#3d2817'),
      cone('face', [0.09, 0.08, 0.06], [-0.14, 0.03, 0.26], '#8c6820', {
        sides: 16,
        turn: [QUARTER, 0, 0],
      }),
      cone('face', [0.09, 0.08, 0.06], [0.14, 0.03, 0.26], '#8c6820', {
      ...
      cube('face', [0.38, 0.1, 0.03], [0, 0.03, 0.285], '#1b2e22'),
    ],
  },
};
