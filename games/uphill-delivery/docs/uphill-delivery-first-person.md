...
The requested design reuses the game's rendering, controls, multiplayer physics and sound workshop. First person uses a 1.65 m eye height, with a level horizon and no head bob. It was the default during a delivery until 11 September 2026; deliveries now start in the outside follow camera. Mouse capture is optional; mouse/touch dragging and IJKL work without it. WASD and the joystick move relative to horizontal view direction. V cycles all four cameras. The depot retains its mountain overview. Help, blur, hidden tabs and camera changes release controls and mouse capture.
