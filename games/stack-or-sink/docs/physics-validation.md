...
The deployment is packaged from the last published revision plus the owned physics files in `work/physics-release`. Unrelated collection/Blend Business work in the shared checkout is excluded from this release.
