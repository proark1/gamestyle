...
export const siegeCatalog: Cue[] = [
  ...
  fx(
    'event.topple',
    'Tower toppled',
    'A triumphant fanfare as a stone tower collapses with a comic rooster squawk or rolling rumble.',
    2.8,
    0.95,
  ),
  fx(
    'event.midair',
    'Mid-air collision',
    'A sharp explosive crack of heavy stones smashing together mid-flight.',
    2.0,
    0.9,
  ),
  fx(
    'event.honk',
    'Goose honk',
    'An alarmed, brassy goose honk and fluttering wings.',
    1.2,
    0.8,
  ),
  fx(
    'event.counterbattery',
    'Engine hit',
    'A splintering direct hit on a siege engine frame with groaning ropes.',
    2.2,
    0.9,
  ),
  bed(
